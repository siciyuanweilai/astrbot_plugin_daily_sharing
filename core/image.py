...
请输出："""
    ...
    async def _build_video_motion_prompt(self, image_description: str, content: str = "") -> str:
...
"""
    ...
    async def _build_video_sound_prompt(self, image_description: str, content: str = "") -> str:
...
"""
    ...
    async def generate_video_from_image(self, image_path: str, content: str) -> Optional[str]:
        ...
        try:
            ...
            motion_prompt = await self._build_video_motion_prompt(image_description, content)
            sound_prompt = await self._build_video_sound_prompt(image_description, content)
    ...
    async def _call_aiimg(self, prompt: str, use_ref_selfie: bool = False) -> Optional[str]:
        ...
        try:
            ...
            if use_ref_selfie and hasattr(self._aiimg_plugin, "edit"):
                logger.info("[DailySharing] 正在使用 Gitee 自拍参考图生成...")
