...
NEWS_TIME_PREFERENCES = {
    ...
    TimePeriod.DAWN: {
        ...
        "acfun": 0.02, "bili": 0.01, "xiaohongshu": 0.01
    },    
    # 早晨
    TimePeriod.MORNING: {
    ...
    # 中午
    TimePeriod.NOON: {
        "weibo": 0.14, "zhihu": 0.12, "douyin": 0.12, "xiaohongshu": 0.10, "bili": 0.08,
    ...
    TimePeriod.LATE_NIGHT: {
        "weibo": 0.20, "zhihu": 0.20, "yicai": 0.15, "douyin": 0.15, "sina": 0.10, "cls": 0.08, 
...
SHARING_TYPE_SEQUENCES = {
    ...
    # ===== 中午时段 (12:00-14:00) =====
    TimePeriod.NOON: [
        SharingType.NEWS.value,        # 中午资讯
        SharingType.MOOD.value,        # 中午心情
    ],
